        ...
        <section id="corpo">
            ...
            <article id="noticia-principal">
                ...
                <p>Não há uma data específica e oficial para o dispositivo ser lançado, ainda. Pode ser que ele esteja disponível em demonstrações a partir de 201X, mas seu lançamento para as lojas fica para,pelo menos, 201Y.</p>
                ...
                <h2>Especificações Técnicas</h2>
                    ...
                    <table id="tabelaspec">
                        ...
                        <caption>
                            Tabela Técnica do Google Glass <span>Jan/201X</span>
                        </caption>

                        <!--        PRIMEIRA LINHA        -->
                        <tr>
                            <td class="ce"><!-- ce = coluna esquerda -->
                                Tela
                            </td>
                            <td class="cd"><!-- cd = coluna direita -->
        ...
        <aside id="lateral">
            ...
            <iframe width="340" height="200" src="https://www.youtube.com/embed/4EvNxWhskf8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
